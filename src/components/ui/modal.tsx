  ...
  <ModalPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'max-sm:max-w-none max-sm:rounded-b-none max-sm:rounded-t-3xl max-sm:max-h-[90vh] max-sm:overflow-y-auto',
        className
      )}
      {...props}
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-2 text-[#7F8C8D] hover:bg-[#ECF0F1] hover:text-[#2C3E50] transition-colors focus:outline-none focus:ring-2 focus:ring-[#3498DB]">
        <X className="h-5 w-5" />
